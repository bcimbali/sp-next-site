    ...
    <PageSection>
      <StyledHeader>
        ...
        <PageSection $textColor={textColor}>
          <InnerContainer>
            <Paragraph>
            A sheet music book for Prince’s “Purple Rain” spotted in the back of BC's car during a session at a mutual friend’s studio was the genesis of Super Public. Intrigued by each other’s knowledge and skill, it was only a matter of days before a TR-707 drum machine and Juno 6 synthesizer were passed back and forth, crafting patterns and textures over the course of the following month. As the songs matured, it became clear that both artists drew inspiration from the geography and industry of Southeastern Michigan. An afternoon spent on Belle Isle watching sheets of ice flow from Lake St. Clair down the Detroit River typified a prelude to a particularly fruitful late night recording session.
            </Paragraph>
          </InnerContainer>
        </PageSection>
